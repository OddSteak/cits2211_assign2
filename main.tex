...
\subsection*{c)}
rs = right sock, ls = left sock, lsh = left shoe, uw = underwear,
tr = trousers, rsh = right shoe, ts = t-shirt, ct = coat, dr = dressed

\begin{tikzpicture}
    \node[draw, circle] (phi) at (0,0) {$\phi$};
    \node[draw, circle] (uw) at (2,1) {$uw$};
    \node[draw, circle] (rs) at (2,3) {$rs$};
    \node[draw, circle] (ls) at (2,-1) {$ls$};
    \node[draw, circle] (ts) at (2,-3) {$ts$};
    \node[draw, circle, right=of uw] (tr) {$tr$};
    \node[draw, circle, right=of rs] (rsh) {$rsh$};
    \node[draw, circle, right=of ls] (lsh) {$lsh$};
    \node[draw, circle, right=of ts] (ct) {$ct$};
    \node[draw, circle] (dr) at (6,0) {$dr$};
...
\begin{tikzpicture}[shorten >=1pt, node distance=2.5cm, on grid, auto]
   ...
   \node[state, right=of q1] (null) {$\phi$};
...
\begin{tikzpicture}[shorten >=1pt, node distance=3cm, on grid, auto]
   ...
   \path[->]
    (q_0) edge  node {$a, \varepsilon \to a$} (q_1)
    (q_1) edge  [loop above] node {$a, \varepsilon \to a$} ()
          edge  node {$b, \varepsilon \to \varepsilon$} (q_2)
    (q_2) edge  [loop above] node {$b, \varepsilon \to \varepsilon$} ()
          edge  node {$a, a \to \varepsilon$} (q_3)
    (q_3) edge  [loop above] node {$a, a \to \varepsilon$} ()
          edge node {$\varepsilon, \$ \to \varepsilon$} (q_4);
\end{tikzpicture}
...
\begin{tikzpicture}[shorten >=1pt, node distance=3cm, on grid, auto]
   ...
   \path[->]
    (q0) edge  node {$a, \varepsilon \to a$} (q1)
    (q1) edge  [loop above] node {$a, \varepsilon \to a$} ()
         edge  node {$b, \varepsilon \to \varepsilon$} (q2)
         edge  [bend left] node {$b, a \to \varepsilon$} (q3)
    (q2) edge  node {$b, a \to \varepsilon$} (q3)
    (q3) edge  [bend left] node {$\varepsilon, a \to a$} (q1)
